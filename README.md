...
![CDC Streaming Analytics Architecture](./Flow-chart.png)

> This diagram illustrates the end-to-end streaming analytics pipeline: synthetic user data is generated by an Airflow DAG, inserted into PostgreSQL, captured through Debezium CDC, streamed via Redpanda, processed by a Python consumer, stored in ClickHouse for analytics, and visualized in Metabase dashboards.
